...
import com.hopen.bluetoothdarts.R.layout;
...
public class GameHighScoreActivity extends Activity {

	// @Override
	// protected void onCreate(Bundle savedInstanceState) {
	// super.onCreate(savedInstanceState);
	// setContentView(R.layout.activity_game_high_score);
	// }
	...
	// private MickeySetting MickeySetting;
	...
	public Handler mHandler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			case Constant.GAMEOVER_PW:
				 ...
				 */
				GameHighScoreActivity.this.finish();
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		game_title.setText(R.string.GameHighScore);
		// 显示初始分数
	...
	private void initView() {
		context = GameHighScoreActivity.this;

		// 用来显示玩家1、2、3、4的字符串实现国际化
	...
	// 一局游戏中的变量（玩家初始分数、游戏类型、玩家总人数、总卡片数、总回合数）
	...
	protected void onResume() {
		// TODO Auto-generated method stub
		super.onResume();
		ble = BluetoothLe.getInstance(GameHighScoreActivity.this
				.getApplication());
		...
		public void onReceive(Context context, Intent intent) {
			...
			if (BluetoothLe.ACTION_GATT_CONNECTED.equals(action)) {
				...
				bluetoothDialog = BluetoothDialog
						.getRemindDialogInstance(GameHighScoreActivity.this);
