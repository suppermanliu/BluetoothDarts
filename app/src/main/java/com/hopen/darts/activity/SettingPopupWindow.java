...
public class SettingPopupWindow {
	...
	private ImageView setting, backdart, rules, gameover;
	private Context mContext;
	private Handler mHandler;
	private SoundPlayManage soundPlay;
	public SettingPopupWindow(Context mContext, Handler mHandler) {
		super();
	...
	private void initView() {		
		...
		View view = mInflater.inflate(R.layout.settingpw, null, false);
	...
	private OnClickListener ClickListener = new OnClickListener() {
		...
		public void onClick(View arg0) {
			...
			switch (arg0.getId()) {
			case R.id.setting:
				setting.setImageResource(R.drawable.seting_text2);
				msg.what = Constant.GAMESETTING_PW;
